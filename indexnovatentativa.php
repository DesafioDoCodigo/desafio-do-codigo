...
<script>
  ...
  ga('send', 'pageview');
    ...
    <body>
        ...
        <div style="max-width: 90%;margin-left: auto;margin-right: auto; margin-top: -2%; padding-top: 2%; background-color:rgba(0, 0, 0, 0.6); ">
        <div class="row">
        
        <div class="col l12 s12">
        
        <br />
       <a href="/desafio">  <img src="../images/LOGO-DESAFIO2016white.png" width="300px" class="logo"/></a>
        ...
        <div class="col l4 s12">
         <iframe src="https://desafiodocodigo.com.br/counter/total.php" width="100%"  height="400px" style="border: 0; margin-top: 3%;"></iframe>
	...
	<div id="login" class="col s12">
			...
			<div class="form-container">
				...
				<center>
					...
					<br/>
					<br/>	<br/>
					<a href='#senhaesqueci' data-toggle="modal" style="color: #9e9e9e; font-size: 1.5rem;text-decoration: underline;font-weight: 700;">Esqueci a Senha :(</a>
				</center>
                <br/>
					<br/>
			</div>
		...
		<form class="col s12" action="" method="post">
			...
			<h3 class="teal-text">Crie sua Conta</h3>
				<div class="row">
					...
					<label id="titulo" class="has-control" for="flogin">Usuário</label>
					</div>
                    </div>
                    </div>
                    	<div class="row">
					<div class="input-field col s12">
						<input type="password" name="password" id="password" class="form-crie" required="required">
						<label for="password">Senha</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s12">
					<input type="email" name="email" class="form-crie" id="email" value="" required autocomplete="email">
						<label for="email">Email</label>
					</div>
				</div>
				<div class="row">
                <p align="left" style="margin-left: 8px;margin-bottom:-13px"><label class="data" for="date">Data de Nascimento</label></p>
					<div class="input-field col s12">
			 ...
			 <p style="font-size: 0.7em; text-align: right;color: #999;">Ao criar a sua conta, você concorda com as condições <br/>do <a href="https://desafiodocodigo.com.br/termo-uso.php" target="_blank" style="color: #999; text-decoration: underline;">Termo de Uso</a>.</p>
                    <p>&nbsp;</p>       
				<center>                    
                            <button type="button" id="submit" class="btn waves-effect waves-light teal btn-success">Enviar</button>
				</center>
                <br/>
					<br/>
			</div>
...
<div class="modal fade in" id="novasenha" style="color:#282828;display:block;text-align: left;">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          Insira seu nome de usuário e o código de recuperação enviado por e-mail:</br>
          <div class="form-group">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
        <button type="button" id="butpass" name="butpass" class="btn btn-primary">Recuperar! <i class="fa fa-key"></i></button>
      </div>
    </div>
  </div>
</div>
